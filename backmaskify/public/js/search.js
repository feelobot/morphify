...
//**********************************************************
  ...
  $('.yt-link a').live("click", function(event){
    ...
    console.log(ytid);
    console.log(title);
    $('#results').html("<p align='center'><img width='50px' src='/imgs/Loading_Animation.gif'/></p>");
    ...
    {
      $('#results').html('<audio autoplay="autoplay" controls="controls"><source src="songs/backmasked/'+ytid+'.wav">Your browser does not support the audio tag.</audio>');
    });
    return false;
  });
});
